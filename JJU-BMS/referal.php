...
<head>
    <title>Referal Hosiptal Head</title>
...
<body>
    <?php $_SESSION['referal'] = " Head of Referal Hosiptal";
    ?>

    <header>
        <div class="navbar navbar-dark bg-dark box-shadow">
            <div class="container d-flex justify-content-between">
                <a href="referal.php" class="navbar-brand d-flex align-items-center">
                    <strong>Welcome <?php echo $_SESSION['referal'] ?></strong>
                </a>
                <div class="ml-auto">
    ...
    <div class="container">
        <section class="jumbotron text-center">
            <div class="container">
                ...
                ?>
                        ...
                        <h4> Hai <?php echo $_SESSION['referal'] ?> <?php echo $row['amount'] ?> is allocated for your Plan</h4>
                        <p class="lead text-muted"> Reason : <?php echo $row['type'] ?></p> <a href="referal.php?delete=<?php echo $id;  ?>"> <button class="btn btn-danger">Delete</button></a>
                        <p>
                ...
                if (isset($_GET['delete'])) {
                    ...
                    $my =  mysqli_query($conn, "delete from referalhead where id ='$id' ");
                    if ($my) {
        ...
        <h2 class="display-4 text-center ">Referal Head</h2>
        <br>
        <div class="row">
            <div class="col-6">
                <div>
                    ...
                    <div class="card">
                        <div class="card-header text-center ">Head of Referal Plan</div>
                        <div class="card-body">
                 ...
                 VALUES (NULL, '$planname', CURRENT_TIMESTAMP, '$detail', '$message')";
                            ...
                            <div class="jumbotron">
                                <h1 class="text-center">Head Of Referal Hosiptal</h1>
            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-header text-center">Head Of Referal Hosiptal Expense Report </div>
                    <div class="card-body">
                        <?php
