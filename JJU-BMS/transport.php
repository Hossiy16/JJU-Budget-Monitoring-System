...
if (isset($_SESSION['transport'])) {
    //echo 'Welcome' . $_SESSION['transport'];
...
<head>
    <title>Transport Director</title>
...
<body>
    <?php $_SESSION['transport'] = " Head of Transport Service";
    ?>
    <header>
        <div class="navbar navbar-dark bg-dark box-shadow ">
            <div class="container d-flex justify-content-between">
                <a href="transport.php" class="navbar-brand d-flex align-items-center">
                    <strong>Welcome <?php echo $_SESSION['transport'] ?></strong>
                </a>
                <div class="ml-auto">
    ...
    <div class="container">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                $query = "SELECT * FROM transporthead;";
                ...
                ?>
                        ...
                        <h4> Hai <?php echo $_SESSION['transport'] ?> <?php echo $row['amount'] ?> is allocated for your Plan</h4>
                        <p class="lead text-muted"> Reason : <?php echo $row['type'] ?></p> <a href="transport.php?delete=<?php echo $id;  ?>"> <button class="btn btn-danger">Delete</button></a>
                            <p>
...
<?php
            if (isset($_GET['delete'])) {
               ...
               $my =  mysqli_query($conn, "delete from transporthead where id ='$id' ");
                if($my){
        ...
        <h2 class="display-4 text-center ">Transport Head</h2>
        <br>
        <div class="row">
            <div class="col-6">
                <div>
                    ...
                    <div class="card">
                        <div class="card-header text-center ">Head of Transport Plan</div>
                        <div class="card-body">
                 ...
                 VALUES (NULL, '$planname', CURRENT_TIMESTAMP, '$detail', '$message')";
                            ...
                            <div class="jumbotron">
                                <h1 class="text-center">Head Of Transport</h1>
            ...
            <div class="col-6">
                ...
                <div class="card">
                    <div class="card-header text-center">Head Of Transport Expense Report </div>
                    <div class="card-body">
                        <?php
