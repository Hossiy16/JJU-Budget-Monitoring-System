...
<head>
    <title>Student Service Head</title>
...
<body>
    <?php $_SESSION['student'] = " Head of Student Service";
    ?>
    <header>
        <div class="navbar navbar-dark bg-dark box-shadow">
            <div class="container d-flex justify-content-between">
                <a href="student.php" class="navbar-brand d-flex align-items-center">
                    <strong>Welcome <?php echo $_SESSION['student'] ?></strong>
                </a>
                <div class="ml-auto">
    ...
    <div class="container">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                ?>
                        ...
                        <h4> Hai <?php echo $_SESSION['student'] ?> <?php echo $row['amount'] ?> is allocated for your Plan</h4>
                        <p class="lead text-muted"> Reason : <?php echo $row['type'] ?></p> <a href="student.php?delete=<?php echo $id;  ?>"> <button class="btn btn-danger">Delete</button></a>
                        <p>
                ...
                if (isset($_GET['delete'])) {
                    ...
                    $my =  mysqli_query($conn, "delete from studenthead where id ='$id' ");
                    if ($my) {
        ...
        <h2 class="display-4 text-center ">Card Header and Footer</h2>
        <br>
        <div class="row">
            <div class="col-6">
                <div>
                    ...
                    <div class="card">
                        <div class="card-header text-center ">Head of Student Plan</div>
                        <div class="card-body">
                 ...
                 VALUES (NULL, '$planname', CURRENT_TIMESTAMP, '$detail', '$message')";
                            ...
                            <div class="jumbotron">
                                <h1 class="text-center">Head Of Student</h1>
            ...
            <div class="col-6">
                <h3 class="text-center">Student Service Head</h3>

                <div class="card">
                    <div class="card-header text-center">Head Of Student Expense Report </div>
                    <div class="card-body">
                        <?php
